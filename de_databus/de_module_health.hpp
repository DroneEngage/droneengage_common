...
namespace de
{
    namespace comm
    {
         ...
         * any C++ module that links de_common can self-report memory health to the
         * GCS via de_comm (see CFacade_Base::sendMemoryStatus()) without needing an
         * external watchdog. Node.js servers (which don't link de_common) still need
